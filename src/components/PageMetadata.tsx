...
const pages = [
  ...
  { match: (path: string) => path === '/history/gallery', title: 'History Gallery | Carleton Lodge No. 465', description: 'Historical photographs, documents, buildings and artifacts of Carleton Lodge No. 465 — with honest labels, credits and pending-acquisition slots.' },
  { match: (path: string) => path === '/history/sources', title: 'History Sources & Research | Carleton Lodge No. 465', description: 'The source register, evidence methodology, image rights and open research questions behind the Carleton Lodge history archive.' },
