...
export const historyArtifacts: HistoryArtifact[] = [
  {
  ...
  {
    id: 'setting-maul',
    name: 'The Le Havre setting maul',
    description:
      "A wooden setting maul presented by Captain Firebrace, the first Master of La Loge Le Havre de Grâce. Its timber was said to have first formed part of a warship's rib and later to have spent more than a century in the frame of a Masonic Hall. A century after the Le Havre Lodge was created, the maul was associated with Carleton Lodge's participation in the 2016 cornerstone ceremony of the West Carleton War Memorial.",
    status: 'held',
    sources: ['S01'],
    imageId: 'IMG09',
  },
  {
    id: 'altar-campbell',
    name: 'Lodge altar — A. F. Campbell & Son, Arnprior',
    description:
      'The Le Havre collection did not include an altar. Carleton Lodge obtained one from A. F. Campbell & Son of Arnprior.',
    status: 'held',
    sources: ['S01'],
  },
  {
