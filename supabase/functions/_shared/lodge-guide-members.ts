...
const CONTACT_QUESTION_PATTERN = /\b(email|e-mail|contact|reach|phone|telephone|call|message)\b/i;

export const lodgeGuideQuestionNeedsSupportContact = (question: string) =>
  CONTACT_QUESTION_PATTERN.test(question);

export const lodgeGuideMemberSourceBody = (member: LodgeGuideMemberDirectoryRow) => [
